		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "Video Source Type", 'zion-builder' ),
						"description" => __( "Select the type of video source.", 'zion-builder' ),
						"id"          => "vb_video_source",
						"std"         => "external",
						"type"        => "select",
						"options"		=> array(
							"external_yt" => __("Youtube",'zion-builder'),
							"external_vim" => __("Vimeo",'zion-builder'),
							"selfhosted_clean" => __("Self hosted video (Clean browser player)",'zion-builder'),
							"selfhosted" => __("Self hosted video (MediaElement Player)",'zion-builder'),
							"external_other" => __("Other External Source",'zion-builder'),
						),
					),

					array (
						"name"        => __( "Video URL", 'zion-builder' ),
						"description" => __( "Please enter a link to your desired video ( Youtube, Vimeo or other ).", 'zion-builder' ),
						"id"          => "video_url",
						"std"         => "",
						"type"        => "text",
						"class"		=> "zn_input_xl",
					...
					array(
						...
						'description' => __('Enable autoplay for video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
							"0"  => __( "No", 'zion-builder' )
						),
					...
					array(
						...
						'description' => __('Enable looping the video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						...
						'name'        => __('Video controls','zion-builder'),
						'description' => __('Enable video controls?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						...
						'name'        => __('Youtube Video - Modest branding','zion-builder'),
						'description' => __('Display modest branding for Youtube video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						...
						'name'        => __('Youtube Video - Autohide branding','zion-builder'),
						'description' => __('Autohide branding for Youtube video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						...
						'name'        => __('Youtube Video - Show Info','zion-builder'),
						'description' => __('Hide various info for the youtube video?','zion-builder'),
						'std'         => '0',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						'id'          => 'source_vd_rel',
						'name'        => __('Youtube Video - Hide Related','zion-builder'),
						'description' => __('Hide related videos on the video ending?','zion-builder'),
						'std'         => '0',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						'id'          => 'source_vd_title',
						'name'        => __('Vimeo Video - Hide title','zion-builder'),
						'description' => __('Hide title for Vimeo video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						'id'          => 'source_vd_byline',
						'name'        => __('Vimeo Video - Hide Video uploader','zion-builder'),
						'description' => __('Hide video uploader (author) for Vimeo video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
					...
					array(
						...
						'name'        => __('Vimeo Video - Hide Avatar','zion-builder'),
						'description' => __('Hide uploader avatar for Vimeo video?','zion-builder'),
						'std'         => '1',
						'type'        => 'zn_radio',
						"options"     => array (
							"1" => __( "Yes", 'zion-builder' ),
			...
			'spacing' => array(
				...
				'options' => array(
					...
					array(
						...
						"description" => __( "Customize the size of this video.", 'zion-builder' ),
						"id"          => "max_width",
						'type'        => 'smart_slider',
						'std'        => '100',
						'helpers'     => array(
...
ZNB()->elements_manager->registerElement( new ZNB_Video(array(
	'id' => 'ZnVideo',
	'name' => __('Video', 'zion-builder'),
	'description' => __('Video player or Image triggering a modal window with a Youtube or Vimeo video.', 'zion-builder'),
	'level' => 3,
