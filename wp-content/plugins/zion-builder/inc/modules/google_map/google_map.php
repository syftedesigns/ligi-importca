...
class ZNB_GoogleMap extends ZionElement {
		...
		$options = array(
			...
			'general'  => array(
				...
				'options' => array(
					...
					array(
						"name"        => __( "Google Maps Api Key (Mandatory!)", 'zion-builder' ),
						"description" => __( 'Add a Google Map Api Key. More on <a target="_blank" href="https://developers.google.com/maps/documentation/javascript/get-api-key#get-an-api-key">Google Maps Key</a>', 'zion-builder' ),
						"id"          => "map_apikey",
						"std"         => "",
						"type"        => "text",
						"class"       => "zn_input_xl",
					...
					array(
						'id'            => 'locations',
						'name'          => __( 'Locations', 'zion-builder' ),
						'description'   => __( 'Here you can add your map locations.', 'zion-builder' ),
						'type'          => 'group',
						'sortable'      => true,
						'element_title' => __( 'Map Location', 'zion-builder' ),
						'subelements'   => array(
							array(
								"name"        => __( "Marker Latitude", 'zion-builder' ),
								"description" => sprintf( __( 'Please enter the latitude value for your location. Here\'s 2 links where you can get the coordinates <a href="%s" target="_blank">LatLong.net</a> or <a href="%s" target="_blank">iTouchMap.com</a>', 'zion-builder' ), $latlong_url, $itouchmap_url ),
								"id"          => "map_latitude",
								"std"         => "41.447390",
								"type"        => "text",
							),
							array(
								"name"        => __( "Marker Longitude", 'zion-builder' ),
								"description" => sprintf( __( 'Please enter the longitude value for your location. Here\'s 2 links where you can get the coordinates <a href="%s" target="_blank">LatLong.net</a> or <a href="%s" target="_blank">iTouchMap.com</a>', 'zion-builder' ), $latlong_url, $itouchmap_url ),
								"id"          => "map_longitude",
								"std"         => "-72.843868",
								"type"        => "text",
							),
							array(
								"name"        => __( "Marker tooltip", 'zion-builder' ),
								"description" => __( "Add a text that will appear when the user clicks on the marker.", 'zion-builder' ),
								"id"          => "tooltip",
								"type"        => "textarea",
							),
							array(
								"name"        => __( "Marker location icon", 'zion-builder' ),
								"description" => __( "Select an icon that will appear as your current location. The default icon will be used if this is left blank.", 'zion-builder' ),
								"id"          => "map_icon",
								"std"         => "",
								'class'       => 'zn_full',
								"type"        => "media",
							...
							array(
								"name"        => __( "Marker animation", 'zion-builder' ),
								"description" => __( "Select an animation that the icon will use.", 'zion-builder' ),
								"id"          => "map_icon_animation",
								"std"         => "",
								"type"        => "select",
								"options"     => array( "" => __( "None", 'zion-builder' ), "DROP" => __( "Drop", 'zion-builder' ), "BOUNCE" => __( "Bounce", 'zion-builder' ) ),
							),
							array(
								"name"        => __( "Icon size", 'zion-builder' ),
								"description" => __( "Select the size of the marker icon.", 'zion-builder' ),
								"id"          => "icon_size",
								"type"        => "select",
								"options"     => $icon_sizes,
							),
					...
					array(
						"name"        => __( "Zoom level", 'zion-builder' ),
						"description" => __( "Select the start zoom level you want to use for this map ( default is 14 )", 'zion-builder' ),
						"id"          => "map_zoom",
						"std"         => "14",
						"type"        => "select",
						"options"     => $zoom,
					...
					array(
						"name"        => __( "Map Type", 'zion-builder' ),
						"description" => __( "Select the desired map type you want to use.", 'zion-builder' ),
						"id"          => "map_type",
						"std"         => "roadmap",
						"type"        => "select",
						"options"     => array(
							"ROADMAP"   => __( "Roadmap", 'zion-builder' ),
							"SATELLITE" => __( "Satellite", 'zion-builder' ),
							"TERRAIN"   => __( "Terrain", 'zion-builder' ),
							"HYBRID"    => __( "Hybrid", 'zion-builder' ),
						),
						"class" => "",
					),
					array(
						"name"        => __( "Add directions box", 'zion-builder' ),
						"description" => __( "Select if you want to add a textbox in which the user can enter a departure location and get directions to the office location (first one if there are more than one).", 'zion-builder' ),
						"id"          => "map_directions",
						"std"         => 'yes',
						"type"        => "toggle2",
						"value"       => "yes",
					...
					array(
						"name"        => __( "Directions box text", 'zion-builder' ),
						"description" => __( "Please enter the direction box text you want to use.", 'zion-builder' ),
						"id"          => "map_directions_text",
						"std"         => __( 'Visit us from...', 'zion-builder' ),
						"type"        => "text",
						'dependency'  => array( 'element' => 'map_directions', 'value' => array('yes') ),
					),

					array(
						"name"        => __( "Directions box position", 'zion-builder' ),
						"description" => __( "Please select the direction box's position.", 'zion-builder' ),
						"id"          => "map_directions_pos",
						"std"         => 'top-left',
						"type"        => "select",
						"options"     => array(
							"top-left"      => __( "Top Left", 'zion-builder' ),
							"middle-left"   => __( "Middle Left", 'zion-builder' ),
							"bottom-left"   => __( "Bottom Left", 'zion-builder' ),
							"top-right"     => __( "Top Right", 'zion-builder' ),
							"middle-right"  => __( "Middle Right", 'zion-builder' ),
					...
					array(
						'id'          => 'show_overview',
						'name'        => __( 'Show overview map', 'zion-builder' ),
						'description' => __( 'Select if you wish to add the overview map option', 'zion-builder' ),
						'type'        => 'toggle2',
						'std'         => '',
						'value'       => 'yes',
					),
					array(
						'id'          => 'show_streetview',
						'name'        => __( 'Show street view', 'zion-builder' ),
						'description' => __( 'Select if you wish to add the street view option', 'zion-builder' ),
						'type'        => 'toggle2',
						'std'         => '',
						'value'       => 'yes',
					),
					array(
						'id'          => 'show_maptype',
						'name'        => __( 'Show map type', 'zion-builder' ),
						'description' => __( 'Select if you wish to add the map type option', 'zion-builder' ),
						'type'        => 'toggle2',
						'std'         => '',
						'value'       => 'yes',
					),
			...
			'styling' => array(
				...
				'options' => array(
					...
					array(
						"name"        => __( "Map Height", 'zion-builder' ),
						"description" => __( "Please select value in pixels for the map height. <br>*TIP: Use 100vh to have a full-height element.", 'zion-builder' ),
						"id"          => "map_height",
						'type'        => 'smart_slider',
						'std'         => '',
						'helpers'     => array(
					...
					array(
						'id'          => 'use_custom_style',
						'name'        => __( 'Map custom style', 'zion-builder' ),
						'description' => sprintf( __( 'Use a custom map style. You can get custom styles from <a href="%s" target="_blank">%s</a>', 'zion-builder' ), $mapstyleurl, $mapstyleurl ),
						'type'        => 'toggle2',
						'std'         => '',
						'value'       => 'yes',
					),
					array(
						'id'          => 'custom_style',
						'name'        => __( 'Normal map style', 'zion-builder' ),
						'description' => sprintf( __( 'Paste your custom style here (Javascript style array). You can get custom styles from <a href="%s" target="_blank">%s</a>', 'zion-builder' ), $mapstyleurl, $mapstyleurl  ),
						'type'        => 'textarea',
						'std'         => '',
					...
					array(
						...
						'name'        => __( 'Active map style (when a popup is visible)', 'zion-builder' ),
						'description' => sprintf( __( 'Paste your custom style here (Javascript style array). You can get custom styles from <a href="%s" target="_blank">%s</a>', 'zion-builder' ), $mapstyleurl, $mapstyleurl  ),
						'type'        => 'textarea',
						'std'         => '',
						'dependency'  => array( 'element' => 'use_custom_style', 'value' => array('yes') ),
			...
			'misc' => array(
				...
				'options' => array(
					...
					array(
						"name"        => __( "Custom center point", 'zion-builder' ),
						"description" => __( "You might want to have the center point of the map onto the a side. Therefore you can custom center the map to show all markers.", 'zion-builder' ),
						"id"          => "sc_ccenter",
						"std"         => "",
						"value"       => "1",
						"type"        => "toggle2",
					...
					array(
						"name"        => __( "Allow Mousewheel", 'zion-builder' ),
						"description" => __( "Select if you want to allow map zooming using the mouse scroll (may interfere with page scroll).", 'zion-builder' ),
	...
	function element() {
		if ( ! $this->validation( 'locations' ) ) {
			echo '<div class="zn-pb-notification">' . __( 'Please configure the element options and add <u>at least one location</u>.', 'zion-builder' ) . '</div>';
			return;
		} else {
			if ( ! $this->validation( 'key' ) && ZNB()->utility->isActiveEditor() ) {
				$key_notice = sprintf(
				'%s <a href="%s" target="_blank">%s</a>.',
				__( 'Please add a <u>Google Maps API Key</u>.', 'zion-builder' ),
				...
				__( 'Generate one here', 'zion-builder' )
			);
		...
		<div <?php echo zn_join_spaces( $attributes ); ?>>
			...
			?>
				<div class="zn-visit-container zn-visit--pos-<?php echo esc_attr( $this->opt( 'map_directions_pos', 'top-left' ) ); ?>">
					<input type="text" required placeholder="<?php echo esc_attr( $this->opt( 'map_directions_text', __( 'Visit us from...', 'zion-builder' ) ) ); ?>" class="zn-visit-startLocation" />
...
ZNB()->elements_manager->registerElement( new ZNB_GoogleMap( array(
	'id'          => 'ZnGoogleMap',
	'name'        => __( 'Google Map', 'zion-builder' ),
	'description' => __( 'This element will render a Google Map.', 'zion-builder' ),
	'level'       => 3,
