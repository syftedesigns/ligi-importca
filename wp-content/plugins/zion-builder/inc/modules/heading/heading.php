		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "Title Text", 'zion-builder' ),
						"description" => __( "Add the title. Shortcodes and HTML code are allowed.", 'zion-builder' ),
						"id"          => "title",
						"std"         => __("Hello World!",'zion-builder'),
						"type"        => "textarea",
					),

					array (
						"name"        => __( "Title Heading Type", 'zion-builder' ),
						"description" => __( "Select a title heading. The title will be wrapped in this tag.", 'zion-builder' ),
						"id"          => "tag",
						"std"         => "h3",
						"type"        => "select",
						"options"     => array(
								...
								"h6" => "H6",
								"div" => "div",
								"p" => __("Paragraph",'zion-builder'),
							)
					),

					array (
						"name"        => __( "Add Link", 'zion-builder' ),
						"description" => __( "Add a link to this heading.", 'zion-builder' ),
						"id"          => "link",
						"std"         => "",
						"type"        => "link",
					...
					array (
						// "name"        => __( "Title Typography settings", 'zion-builder' ),
						// "description" => __( "Adjust the typography of the title as you want on any breakpoint", 'zion-builder' ),
						"id"          => "font_breakpoints",
						"std"         => "lg",
						"tabs"        => true,
						"type"        => "zn_radio",
					...
					array (
						"name"        => __( "Title settings", 'zion-builder' ),
						"description" => __( "Specify the typography properties for the title.", 'zion-builder' ),
						"id"          => "title_typo",
						"std"         => '',
					...
					array (
						"name"        => __( "Color", 'zion-builder' ),
						"description" => __( "Choose the text color.", 'zion-builder' ),
						"id"          => "color",
						"std"         => "",
						"type"        => "colorpicker",
						"alpha"       => "true",
					...
					array (
						"name"        => __( "Hover Color", 'zion-builder' ),
						"description" => __( "Choose the Hover Color. Will work only if linked!!", 'zion-builder' ),
						"id"          => "hover_color",
						"std"         => "",
						"type"        => "colorpicker",
						"alpha"       => "true",
			...
			'spacing' => array(
				'title' => __('Spacing settings','zion-builder'),
				'options' => array(
...
ZNB()->elements_manager->registerElement( new ZNB_Heading(array(
	'id' => 'ZnHeading',
	'name' => __('Heading', 'zion-builder'),
	'description' => __('This element will generate a heading element.', 'zion-builder'),
	'level' => 3,
	'category' => 'content',
	'legacy' => false,
