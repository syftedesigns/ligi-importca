...
class ZNB_Accordion extends ZionElement
{
	...
	{
		$extra_options = array (
			"name"           => __( "Accordions", 'zion-builder' ),
			"description"    => __( "Here you can create your desired accordions.", 'zion-builder' ),
			"id"             => "accordion_single",
			"std"            => "",
			"type"           => "group",
			"group_sortable" => true,
			...
			"subelements"    => array (
				...
				array (
					"name"        => __( "Title", 'zion-builder' ),
					"description" => __( "Please enter a title for this accordion.", 'zion-builder' ),
					"id"          => "acc_title",
					"std"         => "",
					"type"        => "text"
				),
				array (
					"name"        => __( "Expanded?", 'zion-builder' ),
					"description" => __( "Select yes if you want this panel to be expanded on page load.", 'zion-builder' ),
					"id"          => "acc_colapsed",
					"std"         => "no",
					"options"     => array (
		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "Collapse Behavior", 'zion-builder' ),
						"description" => __( "Select the behavior of the collapsible panels. Upon click, Accordion Functionality will close other panels, while toggle just opens/closes the current clicked panel.", 'zion-builder' ),
						"id"          => "acc_behaviour",
						"std"         => "tgg",
						"options"     => array (
							'tgg' => __( 'Toggle', 'zion-builder' ),
							'acc'  => __( 'Accordion', 'zion-builder' )
						),
						"type"        => "select"
					),
					...
					array(
						'id'          => 'element_scheme',
						'name'        => __('Element Color Scheme','zion-builder'),
						'description' => __('Select the color scheme of this element','zion-builder'),
						'type'        => 'select',
						'std'         => 'light',
						'options'        => array(
							'light' => __('Light (default)','zion-builder'),
							'dark' => __('Dark','zion-builder')
						),
						'live'        => array(
							'type'      => 'class',
							'css_class' => '.'.$uid,
...
ZNB()->elements_manager->registerElement( new ZNB_Accordion(array(
	'id' => 'ZnAccordion',
	'name' => __('Accordion', 'zion-builder'),
	'description' => __('This element will generate an accordion collapsible element.', 'zion-builder'),
	'level' => 3,
	'category' => 'Content',
	'legacy' => false,
	'multiple' => true,
