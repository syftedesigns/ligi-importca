		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "List Layout", 'zion-builder' ),
						"description" => __( "Select the list's layout.", 'zion-builder' ),
						"id"          => "list_layout",
						"std"         => "vertical",
						'type'        => 'select',
						'options'        => array(
							'vertical' => __( "Vertical.", 'zion-builder' ),
							'horizontal' => __( "Horizontal.", 'zion-builder' ),
						),
						'live'        => array(
							'type'      => 'class',
					...
					array (
						...
						"description" => __( "Select the list alignment.", 'zion-builder' ),
						"id"          => "alignment",
						"std"         => "center",
						"type"        => "select",
						"options"     => array(
							...
							"justify" => __("Justify", 'zion-builder' ),
						),
						'live'        => array(
							'type'      => 'class',
							'css_class' => '.'.$uid.' .zn-iconList',
					...
					array (
						"name"        => __( "Items Distance", 'zion-builder' ),
						"description" => __( "Select the distance between items.", 'zion-builder' ),
						"id"          => "distance",
						"std"         => "10",
						'type'        => 'slider',
						'helpers'     => array(
					...
					array(
						"name"           => __( "List Items", 'zion-builder' ),
						"description"    => __( "Add List Items.", 'zion-builder' ),
						"id"             => "single_item",
						"std"            => "",
						"type"           => "group",
						"add_text"       => __( "List Item", 'zion-builder' ),
						"remove_text"    => __( "List Item", 'zion-builder' ),
						"group_sortable" => true,
						"element_title" => "text",
						"subelements"    => array (

							array (
								"name"        => __( "List item text", 'zion-builder' ),
								"description" => __( "Here you can add text. Please know it also accepts HTML code.", 'zion-builder' ),
								"id"          => "text",
								"std"         => "",
								"type"        => "textarea"
							),
							array (
								"name"        => __( "List item link", 'zion-builder' ),
								"description" => __( "Wrap the list item into a custom link. If this field is left blank, the item will not be linked.", 'zion-builder' ),
								"id"          => "link",
								"std"         => "",
								"type"        => "link",
							...
							array (
								...
								"description" => __( "Select your desired icon.", 'zion-builder' ),
								"id"          => "icon",
								"std"         => "",
								"type"        => "icon_list",
								'class'       => 'zn_icon_list',
							...
							array (
								"name"        => __( "Icon Color (Custom)", 'zion-builder' ),
							...
							array (
								"name"        => __( "Icon Hover Color (Custom)", 'zion-builder' ),
							...
							array (
								"name"        => __( "Background Color (Custom)", 'zion-builder' ),
			...
			'style' => array(
				...
				'options' => array(
					...
					// COLORS
					array (
						"name"        => __( "Icon Colors" , 'zion-builder' ),
						"id"          => "ibstg_docs",
						"std"         => "",
						"type"        => "zn_title",
					...
					// SIZING
					array (
						"name"        => __( "Icon Sizing" , 'zion-builder' ),
						"id"          => "ibstg_docs",
						"std"         => "",
						"type"        => "zn_title",
						"class"       => "zn_full zn-custom-title-large"
					...
					array (
						"name"        => __( "Icon Decorations" , 'zion-builder' ),
						"id"          => "ibstg_docs",
						"std"         => "",
						"type"        => "zn_title",
						"class"       => "zn_full zn-custom-title-large"
			...
			'other' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "List items typography", 'zion-builder' ),
						"description" => __( "Specify the typography properties for the list items.", 'zion-builder' ),
						"id"          => "list_typo",
						"std"         => '',
	...
	function element()
	{
		...
		echo '<div class="'.zn_join_spaces($classes).'" '. zn_join_spaces( $attributes ) .'>';
			...
			$list_items = $this->opt('single_item', array(
				array(
					'text' => __('List item','zion-builder'),
				),
				array(
					'text' => __('List item','zion-builder'),
				),
...
ZNB()->elements_manager->registerElement( new ZNB_IconList(array(
	'id' => 'ZnIconList',
	'name' => __('IconList', 'zion-builder'),
	'description' => __('Create a vertical or horizontal list with icons.', 'zion-builder'),
	'level' => 3,
	'category' => 'Content',
	'legacy' => false,
