		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						'id'          => 'pb_template',
						'name'        => __('Select Pagebuilder Template', 'zion-builder'),
						'description' => __('Using this option you can select a pre-built Smart Area created in Admin > Page Builder Smart Areas.','zion-builder'),
						'type'        => 'select',
...
ZNB()->elements_manager->registerElement( new ZNB_SmartArea(array(
	'id' => 'ZnSmartArea',
	'name' => __('Page Builder Smart Area', 'zion-builder'),
	'description' => __('This element will display a Smart Area.', 'zion-builder'),
	'level' => 1,
