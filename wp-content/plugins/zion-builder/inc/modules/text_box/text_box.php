			...
			'general' => array(
				...
				'options' => array(
					array (
						...
						"description" => __( "Please enter the box content.<br> ** If you plan on <strong style='color:black'>pasting a shortcode</strong>, please make sure to add it in <strong style='color:black'><em>Text Mode</em></strong> of the editor.", 'zion-builder' ),
						"id"          => "stb_content",
						"std"         => "",
						"type"        => "visual_editor",
						"class"        => "zn_full",
...
ZNB()->elements_manager->registerElement( new ZNB_TextBox(array(
	...
	'name' => __('Text Box', 'zion-builder'),
	'description' => __('Create and display a Text Box element', 'zion-builder'),
	'level' => 3,
	'category' => 'content',
	'keywords' => 'shortcode'
)));
