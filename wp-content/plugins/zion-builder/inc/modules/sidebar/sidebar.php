	...
	function options()
	{
		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					array (
						"name"        => __( "Select sidebar", 'zion-builder' ),
						"description" => __( "Select your desired sidebar to be used on this post", 'zion-builder' ),
						"id"          => "sidebar_select",
						"std"         => "",
						"type"        => "select",
...
ZNB()->elements_manager->registerElement( new ZNB_Sidebar(array(
	'id' => 'ZnSidebar',
	'name' => __('Sidebar', 'zion-builder'),
	'description' => __('This element will display a sidebar.', 'zion-builder'),
	'level' => 3,
	'category' => 'Content',
	'legacy' => false,
)));
