		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array(
						'id'          => 'spacer_height',
						'name'        => __( 'Spacer Height', 'zion-builder'),
						'description' => __( 'Choose the desired height for this element.', 'zion-builder' ),
						'type'        => 'smart_slider',
						'std'        => '30',
						'helpers'     => array(
							"step" => "1",
...
ZNB()->elements_manager->registerElement( new ZNB_Spacer(array(
	'id' => 'ZnSpacer',
	'name' => __('Spacer', 'zion-builder'),
	'description' => __('This element will generate a transparent spacer.', 'zion-builder'),
	'level' => 3,
	'category' => 'Content',
	'legacy' => false,
