...
class ZNB_Tabs extends ZionElement
{
	...
	{
		$extra_options = array (
			"name"           => __( "Tabs", 'zion-builder' ),
			"description"    => __( "Here you can add your desired tabs.", 'zion-builder' ),
			"id"             => "tabs",
			"std"            => "",
			"type"           => "group",
			"add_text"       => __( "Tab", 'zion-builder' ),
			"remove_text"    => __( "Tab", 'zion-builder' ),
			"group_sortable" => true,
			"element_title" => "title",
			"subelements"    => array (
				array (
					"name"        => __( "Tab Title", 'zion-builder' ),
					"description" => __( "Please enter the desired title that will appear as tab.", 'zion-builder' ),
					"id"          => "title",
					"std"         => "",
					"type"        => "text"
				),
				array (
					"name"        => __( "Display Icon?", 'zion-builder' ),
					"description" => __( "Please enter the desired title that will appear as tab.", 'zion-builder' ),
					"id"          => "has_icon",
					"std"         => "",
					"value"         => "1",
		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "Tab Buttons Alignment", 'zion-builder' ),
						"description" => __( "Please select an alignment for the Tab Buttons", 'zion-builder' ),
						"id"          => "tabs_alignment",
						"std"         => "left",
						"type"        => "select",
						'options'     => array(
							...
							'justify' => __( 'Justified', 'zion-builder' ),
						),
						'live' => array(
							'type'      => 'class',
							'css_class' => '.'.$uid,
...
ZNB()->elements_manager->registerElement( new ZNB_Tabs(array(
	'id' => 'ZnTabs',
	'name' => __('Tabs', 'zion-builder'),
	'description' => __('This element will generate group of tabs.', 'zion-builder'),
	'level' => 3,
	'category' => 'Content',
	'legacy' => false,
	'multiple' => true,
