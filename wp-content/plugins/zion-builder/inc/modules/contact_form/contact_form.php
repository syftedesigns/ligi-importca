...
class ZNB_ContactForm extends ZionElement {
	...
	function options() {
		...
		$datepicker_langs = array(
			''      => __('-- Default (English) --','zion-builder'),
			'af'    => __('Afrikaans','zion-builder'),
			'ar-DZ' => __('Algerian Arabic','zion-builder'),
			'ar'    => __('Arabic','zion-builder'),
			'az'    => __('Azerbaijani','zion-builder'),
			'be'    => __('Belarusian','zion-builder'),
			'bg'    => __('Bulgarian','zion-builder'),
			'bs'    => __('Bosnian','zion-builder'),
			'ca'    => __('Catal&#224;','zion-builder'),
			'cs'    => __('Czech','zion-builder'),
			'cy-GB' => __('Welsh/UK','zion-builder'),
			'da'    => __('Danish','zion-builder'),
			'de'    => __('German','zion-builder'),
			'el'    => __('Greek','zion-builder'),
			'en-AU' => __('English/Australia','zion-builder'),
			'en-GB' => __('English/UK','zion-builder'),
			'en-NZ' => __('English/New Zealand','zion-builder'),
			'eo'    => __('Esperanto','zion-builder'),
			'es'    => __('Espa&#241;ol','zion-builder'),
			'et'    => __('Estonian','zion-builder'),
			'eu'    => __('Basque','zion-builder'),
			'fa'    => __('Persian (Farsi)','zion-builder'),
			'fi'    => __('Finnish','zion-builder'),
			'fo'    => __('Faroese','zion-builder'),
			'fr-CA' => __('Canadian-French','zion-builder'),
			'fr-CH' => __('Swiss-French','zion-builder'),
			'fr'    => __('French','zion-builder'),
			'gl'    => __('Galician','zion-builder'),
			'he'    => __('Hebrew','zion-builder'),
			'hi'    => __('Hindi','zion-builder'),
			'hr'    => __('Croatian','zion-builder'),
			'hu'    => __('Hungarian','zion-builder'),
			'hy'    => __('Armenian','zion-builder'),
			'id'    => __('Indonesian','zion-builder'),
			'is'    => __('Icelandic','zion-builder'),
			'it'    => __('Italian','zion-builder'),
			'ja'    => __('Japanese','zion-builder'),
			'ka'    => __('Georgian','zion-builder'),
			'kk'    => __('Kazakh','zion-builder'),
			'km'    => __('Khmer','zion-builder'),
			'ko'    => __('Korean','zion-builder'),
			'ky'    => __('Kyrgyz','zion-builder'),
			'lb'    => __('Luxembourgish','zion-builder'),
			'lt'    => __('Lithuanian','zion-builder'),
			'lv'    => __('Latvian','zion-builder'),
			'mk'    => __('Macedonian','zion-builder'),
			'ml'    => __('Malayalam','zion-builder'),
			'ms'    => __('Malaysian','zion-builder'),
			'nb'    => __('Norwegian Bokm&#229;l','zion-builder'),
			'nl-BE' => __('Dutch (Belgium)','zion-builder'),
			'nl'    => __('Dutch','zion-builder'),
			'nn'    => __('Norwegian Nynorsk','zion-builder'),
			'no'    => __('Norwegian','zion-builder'),
			'pl'    => __('Polish','zion-builder'),
			'pt-BR' => __('Brazilian','zion-builder'),
			'pt'    => __('Portuguese','zion-builder'),
			'rm'    => __('Romansh','zion-builder'),
			'ro'    => __('Romanian','zion-builder'),
			'ru'    => __('Russian','zion-builder'),
			'sk'    => __('Slovak','zion-builder'),
			'sl'    => __('Slovenian','zion-builder'),
			'sq'    => __('Albanian','zion-builder'),
			'sr-SR' => __('Serbian','zion-builder'),
			'sr'    => __('Serbian 2','zion-builder'),
			'sv'    => __('Swedish','zion-builder'),
			'ta'    => __('Tamil','zion-builder'),
			'th'    => __('Thai','zion-builder'),
			'tj'    => __('Tajiki','zion-builder'),
			'tr'    => __('Turkish','zion-builder'),
			'uk'    => __('Ukrainian','zion-builder'),
			'vi'    => __('Vietnamese','zion-builder'),
			'zh-CN' => __('Chinese','zion-builder'),
			'zh-HK' => __('Chinese 2','zion-builder'),
			'zh-TW' => __('Chinese 3','zion-builder'),
		);
		...
		$options = array(
			...
			'general'  => array(
				...
				'options' => array(
					...
					array(
						'id'          => 'email',
						'name'        => __('Recepient(s) email address','zion-builder'),
						'description' => __('Please enter the email address where you want the form submissions to be sent. Note that you can enter multiple recipients separated by comma(,).','zion-builder'),
						'type'        => 'text',
					...
					array (
						"name"        => __( "From (Email Sender)", 'zion-builder' ),
						"description" => __( "It's highly recommended to use an email containing this domain name. It may not work otherwise for some hostings. <br><br> The <strong>'Reply-To'</strong> address is the field you validate as 'Value is Email' eg: <a href='http://hogash.d.pr/3OVS' target='_blank'>http://hogash.d.pr/3OVS</a> .", 'zion-builder' ),
						"id"          => "from_sender",
						"type"        => "text",
						"class"       => "zn_input_xl",
						"std"			=> $this->from_email(),
					...
					array(
						'id'          => 'email_subject',
						'name'        => __('Email subject text','zion-builder'),
						'description' => __('Please enter your desired text that will appear as the subject of the received email. <strong>Note that you can dynamically set the value of this field by specifying the dynamic field in the fields list.</strong>','zion-builder'),
						'std'         => __('New form submission','zion-builder'),
						'type'        => 'text',
						"class"       => "zn_input_xl",
					),
					array(
						'id'          => 'sent_message',
						'name'        => __('Mail sent message','zion-builder'),
						'description' => __('Please enter your desired text that will appear after the form is successfully sent','zion-builder'),
						'std'         => __('Thank you for contacting us','zion-builder'),
						'type'        => 'text',
						"class"       => "zn_input_xl",
					),
					array(
						'id'          => 'redirect_url',
						'name'        => __('Redirect url','zion-builder'),
						'description' => __('Using this option you can redirect the user after the form is succesfully submitted','zion-builder'),
						'std'         => '',
					...
					array(
						'id'          => 'captcha',
						'name'        => __('Show Captcha','zion-builder'),
						'description' => __('Select yes if you want to add a Xaptcha field.','zion-builder'),
						'type'        => 'zn_radio',
						'std'         => 'yes',
						'options'     => array( 'yes' => __('Yes','zion-builder'), 'no' => __('No','zion-builder') ),
						"class"        => "zn_radio--yesno",
					),

					array(
						'id'          => 'captcha_lang',
						'name'        => __('Captcha language','zion-builder'),
						'description' => sprintf( __( 'Enter the desired Captcha language code ( <a href="%s" target="_blank">you can get it from here</a> )', 'zion-builder' ), $recaptcha_language),
						'type'        => 'text',
						'placeholder' => 'en',
			...
			'fields'   => array(
				...
				'options' => array(
					array(
						'id'            => 'fields',
						'name'          => __('Add your own, custom fields:','zion-builder'),
						'description'   => __('Here you can create your contact form fields','zion-builder'),
						'type'          => 'group',
						'sortable'      => true,
						'element_title' => 'name',
						'subelements'   => array(
							array(
								'id'          => 'name',
								'name'        => __('Field name','zion-builder'),
								'description' => __('Please enter a name for this field','zion-builder'),
								'type'        => 'text',
							),
							array(
								'id'          => 'type',
								'name'        => __('Field type','zion-builder'),
								'description' => __('Please select the field type','zion-builder'),
								'type'        => 'select',
								'options'     => array(
									'text'       => __('Text','zion-builder'),
									'textarea'   => __('Textarea','zion-builder'),
									'select'     => __('Select','zion-builder'),
									'radio'      => __('Radio','zion-builder'),
									'checkbox'   => __('Checkbox','zion-builder'),
									'plain_text' => __('Plain text (accepts HTML)','zion-builder'),
									'datepicker' => __('Datepicker & TimePicker','zion-builder'),
								)
							),
							array(
								'id'          => 'validation',
								'name'        => __('Field validation','zion-builder'),
								'description' => __('Please select the field validation','zion-builder'),
								'type'        => 'select',
								'std'         => 'not_empty',
								'options'     => array(
									'none'      => __('No validation','zion-builder'),
									'not_empty' => __('Value not empty','zion-builder'),
									'is_email'  => __('Value is Email','zion-builder'),
									'is_numeric'  => __('Value is numeric','zion-builder')
								),
								'dependency'  => array(
									'element' => 'type',
									'value'   => array(
							...
							array(
								'id'          => 'select_option',
								'name'        => __('Select/Radio option','zion-builder'),
								'description' => __('Please add your values for the select/radio option type in the following format : value:option name, value2:option name 2. For example "house:House, car:Car, piano:Piano"','zion-builder'),
								'type'        => 'textarea',
								'dependency'  => array(
									'element' => 'type',
							...
							array(
								'id'          => 'select_multiple',
								'name'        => __('Allow multiple select?','zion-builder'),
								'description' => __('Enable if you want the the user to select multiple options.','zion-builder'),
								'class'        => 'zn_radio--yesno',
								'type'        => 'zn_radio',
								'std'        => 'no',
								'options'        => array(
							...
							array(
								'id'          => 'radio_inline',
								'name'        => __('Radio Options Inline?','zion-builder'),
								'description' => __('Enable if you want the radio options to appear inline, rather than blocks.','zion-builder'),
								'class'        => 'zn_radio--yesno',
								'type'        => 'zn_radio',
								'std'        => 'no',
								'options'        => array(
							...
							array(
								'id'          => 'placeholder',
								'name'        => __('Placeholder','zion-builder'),
								'description' => __('Please enter the placeholder value for this field','zion-builder'),
								'type'        => 'text',
								'dependency'  => array(
									'element' => 'type',
							...
							array(
								'id'          => 'datepicker_lang',
								'name'        => __('Datepicker Language','zion-builder'),
								'description' => __('Please select a datepicker language if needed. Needs page refresh!','zion-builder'),
								'std'         => '',
								'type'        => 'select',
							...
							array (
								"name"           => __( "Date format", 'zion-builder' ),
								"description"    => __( "Enter your desired date format. More info about formatting the date can be found", 'zion-builder' ) .' <a target="_blank" href="'.$date_info.'">'.__('here', 'zion-builder').'</a>',
								"id"             => "date_format",
								"type"           => "text",
								"std"            => 'yy-mm-dd',
							...
							array(
								'id'          => 'time_picker',
								'name'        => __('Enable TimePicker?','zion-builder'),
								'description' => __('Do you want this datepicker field to display a time picker field as well?','zion-builder'),
								'type'        => 'toggle2',
								'std'         => '',
								'value'       => 'yes',
								'dependency'  => array(
							...
							array(
								'id'          => 'tpicker_label',
								'name'        => __('Timepicker Label text','zion-builder'),
								'description' => __('Please add the label value for the timepicker field','zion-builder'),
								'type'        => 'text',
								'std'         => __('PICK TIME','zion-builder'),
								'dependency'  => array(
									'element' => 'type',
									'value'   => array( 'datepicker' )
								)
							...
							array(
								'id'          => 'width',
								'name'        => __('Field width','zion-builder'),
								'description' => __('Please select the field width','zion-builder'),
								'type'        => 'select',
								'options'     => array(
									'col-sm-12' => __('Full width','zion-builder'),
									'col-sm-9'  => __('Three-Quarters width','zion-builder'),
									'col-sm-8'  => __('Two-Thirds width','zion-builder'),
									'col-sm-6'  => __('Half width','zion-builder'),
									'col-sm-4'  => __('One-Third width','zion-builder'),
									'col-sm-3'  => __('One-Quarter width','zion-builder'),
									'col-sm-2'  => __('One-Sixth width','zion-builder'),
								)
							),
							array(
			...
			'style'    => array(
				...
				'options' => array(
					...
					array(
						'id'          => 'title1',
						'name'        => __('Form Options','zion-builder'),
						'description' => __('These are options to customize the form inputs.','zion-builder'),
						'type'        => 'zn_title',
					...
					array(
						'id'          => 'cf_labels_pl',
						'name'        => __('Labels or Placeholders?','zion-builder'),
						'description' => __('Choose what to display, ','zion-builder'),
						'type'        => 'select',
						'std'         => ( $this->opt( 'cf_labels', 'yes' ) === 'yes' ? '1' : '4' ),
						'options'     => array( '1' => __('Labels','zion-builder'), '2' => __('Placeholders','zion-builder'), '3' => __('Both','zion-builder'), '4' => __('None','zion-builder') )
					),

					array(
						'id'          => 'gutter_size',
						'name'        => __('Gutter Size (Distance)', 'zion-builder'),
						'description' => __('Select the gutter distance between inputs', 'zion-builder'),
						"std"         => "",
						"type"        => "select",
						"options"     => array (
							'' => __( 'Default (20px)', 'zion-builder' ),
							'gutter-xs' => __( 'Extra Small (5px)', 'zion-builder' ),
							'gutter-sm' => __( 'Small (15px)', 'zion-builder' ),
							'gutter-md' => __( 'Medium (30px)', 'zion-builder' ),
							'gutter-lg' => __( 'Large (50px)', 'zion-builder' ),
							'gutter-0' => __( 'No distance - 0px', 'zion-builder' ),
						),
						'live' => array(
							'type'      => 'class',
					...
					array(
						'id'          => 'title2',
						'name'        => __('Send Button Options','zion-builder'),
						'description' => __('These are options to customize the send button style.','zion-builder'),
						'type'        => 'zn_title',
						'class'        => 'zn_full zn-custom-title-large',
					),
					...
					array(
						'id'          => 'submit_label',
						'name'        => __('Submit button label','zion-builder'),
						'description' => __('Enter a text for the submit button label.','zion-builder'),
						'std'         => __('Send message','zion-builder'),
						'type'        => 'text',
						"class"       => "zn_input_md",
					),

					array(
						"name"        => __( "Send button style", 'zion-builder' ),
					...
					array (
						"name"        => __( "Button Width", 'zion-builder' ),
					...
					array (
						...
						"options"     => array (
							''          => __( "Default", 'zion-builder' ),
							'btn-lg'    => __( "Large", 'zion-builder' ),
							'btn-md'    => __( "Medium", 'zion-builder' ),
							'btn-sm'    => __( "Small", 'zion-builder' ),
							'btn-xs'    => __( "Extra small", 'zion-builder' ),
						),
						'live' => array(
							'type'           => 'class',
							'css_class'      => '.'.$uid.' .zn-formSubmit',
					...
					array (
						"name"        => __( "Button Alignment", 'zion-builder' ),
						"description" => __( "Select the alignment", 'zion-builder' ),
						"id"          => "btn_alignment",
						"std"         => "left",
						"type"        => "select",
						"options"     => array(
					...
					array (
						"name"        => __( "Labels Text Options", 'zion-builder' ),
						"description" => __( "Specify the typography properties for the labels.", 'zion-builder' ),
						"id"          => "labels_typo",
						"std"         => '',
			...
			'advanced'   => array(
				...
				'options' => array(
					...
					array(
						'id'          => 'send_me_copy',
						'name'        => __('Show send me a copy','zion-builder'),
						'description' => __('Select yes if you want to allow users to send a copy of the message to themselves. This requires you to set the email field to have the "is email" validation type.','zion-builder'),
						'type'        => 'zn_radio',
						'std'         => 'no',
						'options'     => array( 'yes' => __('Yes','zion-builder'), 'no' => __('No','zion-builder')  ),
						"class"        => "zn_radio--yesno",
					...
					array(
						'id'          => 'cf_debug',
						'name'        => __('Enable debugging?','zion-builder'),
						'description' => __('If you have problems with the contact form, this option will help debug the problem by showing some errors into the response field.','zion-builder'),
						'type'        => 'toggle2',
						'std'         => '',
						'value'       => '1',
					),
	...
	function element() {
		...
		if ( empty( $fields ) ) {
			echo '<div class="zn-pb-notification">'. __('Please configure the element options and add your contact fields.','zion-builder') .'</div>';
			return;
		}
		...
		if ( $debugEnabled ) {
			...
			echo __('<strong>DEBUG IS ENABLED!</strong> Debug mode is only for development mode and shouldn\'t be enabled in production mode.','zion-builder');
			echo '</div>';
			echo '</div>';
		}
		...
		if ( $this->opt( 'send_me_copy', 'no' ) == 'yes' ) {
			...
			if ( $this->show_labels() ) {
				echo sprintf('<label for="%s" class="zn-formItem-label">%s</label>', $cid, __( 'Send me a copy', 'zion-builder' ) );
			}
		...
		if ( isset( $_POST[ 'zn_pb_form_submit_' . self::$form_id ] ) )
		{
			...
			else
			{
				...
				if ( $this->submit && $emailSent ) {
					$response = '<div class="alert alert-success alert-dismissible zn_cf_response" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' . $this->opt( 'sent_message', __( 'New Contact Form submission', 'zion-builder' ) );
					if ( $debugEnabled ) {
						$response .= '<pre>1</pre>';
					}
					$response .= '</div>';
					...
					$response = '<div class="alert alert-danger alert-dismissible zn_cf_response" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button><strong>';
					$response .= __( 'There was a problem submitting your message. Please try again.', 'zion-builder' );
					if ( $debugEnabled ) {
		...
		echo '<button class="zn-formSubmit btn ' . zn_join_spaces($btn_classes) . '" type="submit">' . $this->opt( 'submit_label', __('Send message', 'zion-builder') ) . '</button>';
		echo '</div>';
	...
	function scripts() {
		if ( $this->opt( 'captcha', 'no' ) == 'yes' ) {
			...
			wp_localize_script( 'znb_recaptcha', 'zn_contact_form', array(
				'captcha_not_filled' => __( 'Please complete the Captcha validation', 'zion-builder' ),
			) );
		}
	...
	function captcha( $field, $id, $value ) {
		...
		if ( empty( $siteKey ) || empty( $pvKey ) ) {
			_e( 'Please enter the reCaptcha public and private keys inside the admin panel!', 'zion-builder' );
			return;
		}
	...
	function validate_field( $field, $id, $value )
	{
		...
		if('captcha' == $validationRule)
		{
			...
			if ( is_wp_error($response) ) {
				...
				$this->error_messages[] = __( 'An error occurred. Please try again in a few moments.', 'zion-builder' );
			}
			...
			if ( $response["success"] !== true )
			{
				if ( ! empty( $response['error-codes'] ) && is_array( $response['error-codes'] ) )
				{
					foreach ( $response['error-codes'] as $key => $value ) {
						if ( $value == 'missing-input-secret' ) {
							$this->error_messages[] = __( 'The secret parameter is missing.', 'zion-builder' );
							continue;
						}
						if ( $value == 'invalid-input-secret' ) {
							$this->error_messages[] = __( 'The secret parameter is invalid or malformed.', 'zion-builder' );
							continue;
						}
						if ( $value == 'missing-input-response' ) {
							$this->error_messages[] = __( 'Please complete the captcha validation', 'zion-builder' );
							continue;
						}
						if ( $value == 'invalid-input-response' ) {
							$this->error_messages[] = __( 'The response parameter is invalid or malformed.', 'zion-builder' );
							continue;
						}
					}
				}
				// response == false, no error codes retrieved, meaning the ReCaptcha is not properly configured
					...
					$this->error_messages[] = __( 'Error: ReCaptcha is not properly configured.', 'zion-builder' );
				}
	...
	function form_send()
	{
		...
		$subject     = $this->opt( 'email_subject' ) ? $this->opt( 'email_subject' ) : __( 'New form submission', 'zion-builder' );
		$message     = '';
		$attachments = '';
		$i = 0;
...
ZNB()->elements_manager->registerElement( new ZNB_ContactForm(array(
	'id' => 'ZnContactForm',
	'name' => __('Contact Form', 'zion-builder'),
	'description' => __('This element will generate a contact form.', 'zion-builder'),
	'level' => 3,
	'category' => 'Content',
	'styles' => true,
	'legacy' => false,
