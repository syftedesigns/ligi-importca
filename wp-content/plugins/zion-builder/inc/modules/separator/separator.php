		...
		$options = array(
			...
			'general' => array(
				...
				'options' => array(
					...
					array(
						'id'          => 'color',
						'name'        => __('Separator color','zion-builder'),
						'description' => __('Select the color for separator line.','zion-builder'),
						'type'        => 'colorpicker',
						'std'		  => '#000000',
						'live' => array(
							'multiple' => array(
					...
					array(
						'id'          => 'height',
						'name'        => __('Separator height','zion-builder'),
						'description' => __('Select the separator line height (in pixels).','zion-builder'),
						'type'        => 'slider',
						'std'		  => '2',
						// 'class'		  => 'zn_full',
						'helpers'	  => array(
					...
					array(
						...
						"description" => __( "Customize the size of this separator.", 'zion-builder' ),
						"id"          => "max_width",
						'type'        => 'smart_slider',
						'std'        => '100',
						'helpers'     => array(
					...
					array (
						"name"        => __( "Separator Alignment", 'zion-builder' ),
						"description" => __( "Choose the separator's alignment.", 'zion-builder' ),
						...
						"class"       => "zn_breakpoints zn--minimal"
							...
							array (
								...
								"description" => __( "Select the separator alignment.", 'zion-builder' ),
								"id"          => "alignment",
								"std"         => "center",
								"type"        => "select",
								"options"     => array(
			...
			'icon' => array(
				...
				'options' => array(
					...
					array (
						"name"        => __( "Add Icon?", 'zion-builder' ),
						"description" => __( "Choose if you want to add an icon in the center of the separator.", 'zion-builder' ),
						"id"          => "enable_icon",
						"std"         => "no",
						"type"        => "zn_radio",
						"options"     => array(
					...
					array (
						...
						"description" => __( "Add icon.", 'zion-builder' ),
						"id"          => "icon",
						"std"         => "",
						"type"        => "icon_list",
						'class'       => 'zn_full',
					...
					array (
						...
						"description" => __( "Select icon color.", 'zion-builder' ),
						"id"          => "icon_color",
						"std"         => "#000",
						"type"        => "colorpicker",
						"dependency"  => array( 'element' => 'enable_icon' , 'value'=> array('yes') ),
					...
					array(
						'id'          => 'icon_size',
						'name'        => 'Icon Size',
						'description' => __('Select the icon size in px.','zion-builder'),
						'type'        => 'slider',
						'std'         => '20',
						'class'       => 'zn_full',
						'helpers'     => array(
...
ZNB()->elements_manager->registerElement( new ZNB_Separator(array(
	'id' => 'ZnSeparator',
	'name' => __('Separator', 'zion-builder'),
	'description' => __('This element will generate a separator line with various styles.', 'zion-builder'),
	'level' => 3,
