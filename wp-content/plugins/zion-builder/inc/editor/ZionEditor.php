...
class ZionEditor {
	...
	public function getPageOptions() {
		$options = array(
			'has_tabs'   => true,
			'custom_css' => array(
				'title'   => __( 'Custom css', 'zion-builder' ),
				'options' => array(
					array(
						'id'          => 'zn_page_custom_css',
						'name'        => __( 'Custom CSS', 'zion-builder' ),
						'description' => __( 'Use this field to add your own custom css that will be applied to the current page.', 'zion-builder' ),
						'type'        => 'custom_code',
						'class'       => 'zn_full',
						'editor_type' => 'css',
					),
			...
			'custom_js' => array(
				...
				'options' => array(
					array(
						...
						'name'        => __( 'Custom JS', 'zion-builder' ),
						'description' => __( 'Use this field to add your own custom javascript code that will be applied to the current page.', 'zion-builder' ),
						'type'        => 'custom_code',
						'class'       => 'zn_full',
	...
	public function defaultOptions( $options ) {
		...
		$default_options[] = array(
			"name"        => __( "Element display?", 'zion-builder' ),
			"description" => __( "Using this option you can show/hide the element for different type of visitors.", 'zion-builder' ),
			"id"          => "znpb_hide_visitors",
			"std"         => "all",
			"type"        => "select",
			"options"     => array(
				"all"      => __( "Show for all", 'zion-builder' ),
				"loggedin" => __( "Show only for logged in users", 'zion-builder' ),
				"visitor"  => __( "Show only for visitors ( not logged in )", 'zion-builder' ),
			),
		);
		...
		if ( isset( $options['znpb_misc']['disable'] ) && in_array( 'znpb_hide_breakpoint', $options['znpb_misc']['disable'] ) ) {
			...
			$default_options[] = array(
				"name"        => __( "Hide element on breakpoints", 'zion-builder' ),
				"description" => __( "Choose to hide the element on either desktop, mobile or tablets. Please know that elements will not be hidden in Page builder edit mode, only normal View mode.", 'zion-builder' ),
	...
	public function get_editor_data() {
		...
		$l10n = array(
			'hidden_text' => esc_attr( __( "This element is hidden!", 'zion-builder' ) ),
		);
	...
	public function getCategories() {
		$categories = array(
			array(
				'filter' => '',
				'name'   => __( 'All elements', 'zion-builder' ),
			),
			array(
				'filter' => 'fullwidth',
				'name'   => __( 'Full width', 'zion-builder' ),
			),
			array(
				'filter' => 'layout',
				'name'   => __( 'Layouts', 'zion-builder' ),
			),
			array(
				'filter' => 'content',
				'name'   => __( 'Content', 'zion-builder' ),
			),
			array(
				'filter' => 'post',
				'name'   => __( 'Single elements', 'zion-builder' ),
			),
			array(
				'filter' => 'media',
				'name'   => __( 'Media', 'zion-builder' ),
			),
			array(
				'filter' => 'headers',
				'name'   => __( 'Headers', 'zion-builder' ),
			),
			array(
				'filter' => 'widgets',
				'name'   => __( 'Widgets', 'zion-builder' ),
			),
		);
	...
	public function loadScripts() {
		...
		$colorpicker_l10n = array(
			'clear'         => __( 'Clear', 'zion-builder' ),
			'defaultString' => __( 'Default', 'zion-builder' ),
			'pick'          => __( 'Select Color', 'zion-builder' ),
		);
