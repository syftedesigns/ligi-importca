...
function mo_openid_gdpr()
{
    ...
    <form id="gdpr" name="gdpr" method="post" action="">
        ...
        <div class="mo_openid_table_layout">
            ...
            <label style="font-size: 12px">Enter the Consent message: </label>
            ...
            <br><br>
            <label style="font-size: 12px"> Enter the text to be displayed for the Privacy Policy URL :</label>
            ...
            <br><br>
            <label style="font-size: 12px">Enter Privacy Policy URL: </label>
