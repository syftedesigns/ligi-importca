...
function mo_openid_show_apps()
{
    ...
    <script>
        ...
        jQuery(function() {
            var popup = '<div class="popup" popup-name="popup-1" border="1" id = "custom_app_div" style="display:none; float: left; width: 100%; overflow: hidden">' +
        ...
        jQuery(function() {
            ...
            var popup2 = '<div class="popup" popup-name="popup-2" border="1" id = "mo_openid_delay_registration" style="display:none; float: left; width: 100%; overflow: hidden">' +
                    ...
                    '<div id="cronmoOpenIdRateUs">\n' +
                        '<span class="star-cb-group" >\n' +
                            '<table style="width: 100%"><tr style="background-color: #0867b2"><td>\n' +
                                '<span style="margin-top: 2%;margin-right: 2%" class="close-button">&times;</span>\n' +
