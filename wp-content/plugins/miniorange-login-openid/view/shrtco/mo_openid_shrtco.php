            ...
            <tr>
                <td>
                    <div id="mo_openid_login_shortcode" style="font-size:13px !important">
                        ...
                        <code id='1'>[miniorange_social_login]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy copytooltip" onclick="copyToClipboard(this, '#1', '#shortcode_url_copy')"><span id="shortcode_url_copy" class="copytooltiptext">Copy to Clipboard</span></i><hr>

                        <h3>For Icons</h3>
                        You can use  different attribute to customize social login icons. All attributes are optional except view.<br/><br/>
                        <b>Square Shape Example:</b> <code id='2'>[miniorange_social_login shape="square" theme="default" space="4" size="35"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy copytooltip" onclick="copyToClipboard(this, '#2', '#shortcode_url1_copy')"><span id="shortcode_url1_copy" class="copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <b>Round Shape Example:</b> <code id='3'>[miniorange_social_login shape="round" theme="default" space="4" size="35"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy copytooltip" onclick="copyToClipboard(this, '#3', '#shortcode_url2_copy')"><span id="shortcode_url2_copy" class="copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <b>Vertical View Example:<br/></b><code id='4'>[miniorange_social_login shape="longbuttonwithtext" theme="default" space="8" width="180" height="35" color="000000"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy copytooltip" onclick="copyToClipboard(this, '#4', '#shortcode_url3_copy')"><span id="shortcode_url3_copy" class="copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <b>Horizontal View Example:</b><code id='5'>[miniorange_social_login shape="longbuttonwithtext" view="horizontal" appcnt="3" theme="default" space="35" width="180" height="35" color="000000"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy copytooltip" onclick="copyToClipboard(this, '#5', '#shortcode_url4_copy')"><span id="shortcode_url4_copy" class="copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <b>Example:</b><code id='6'>[miniorange_social_login apps="vk,google,fb" shape="longbuttonwithtext" view="horizontal" theme="default" space="10" width="200" height="35" color="000000"]</code><i style= "width: 11px;height: 9px;padding-left:2px;padding-top:3px" class="mofa mofa-fw mofa-lg mofa-copy mo_copy copytooltip" onclick="copyToClipboard(this, '#6', '#shortcode_url5_copy')"><span id="shortcode_url5_copy" class="copytooltiptext">Copy to Clipboard</span></i><br/><br/>
                        ...
                        <table style="border-collapse: collapse;width:90%">
                            <tr>
                                <td ><table style="margin-left: 25%; width: 100%" id="shortcode_table">
                                        <tr>
                                            <td><b>Name</b></td>
                                            <td ><b>Value</b></td>
                                        </tr>
                                ...
                                <td ><table style="margin-left: 25%;width: 80%" id="shortcode_table" >
                                        <tr>
                                            <td ><b>Name</b></td>
                                            <td ><b>Value</b></td>
                                        </tr>
                        ...
                        <table style="margin-left: 8%" id="shortcode_table">
                            <tr>
