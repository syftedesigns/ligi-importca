...
?>
    <div class="mo_openid_table_layout">
        <form id="comment_labels" name="comment_labels" method="post" action="" >
            ...
            <input type="hidden" name="mo_openid_enable_comment_labels_nonce"
                   value="<?php echo wp_create_nonce( 'mo-openid-enable-comment-labels-nonce' ); ?>"/>
            <br/><table class="mo_openid_display_table" style="width: 70%">
                ...
                <tr>
                    <td colspan="2"><br /><input type="submit" name="submit" value="Save" style="width:100px;"  class="button button-primary button-large" />
                    </td>
                </tr>
            </table>
        </form>
    ...
    <script>
        jQuery('#mo_openid_page_heading').text('Customize Text For Social Comment Labels');
    </script>
<?php  }