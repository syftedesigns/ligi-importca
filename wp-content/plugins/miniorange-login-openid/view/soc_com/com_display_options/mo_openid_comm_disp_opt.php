    ...
    <div class="mo_openid_table_layout">
        <form id="comment_display" name="comment_display" method="post" action="" >
            ...
            <input type="hidden" name="mo_openid_enable_comment_display_nonce"
                   value="<?php echo wp_create_nonce( 'mo-openid-enable-comment-display-nonce' ); ?>"/>
            <br/>
            <table id="disp_opt" class="mo_openid_display_table">
                ...
                <tr>
                    <td>
                        <label class="mo_openid_checkbox_container"> <b>Blog Post</b>
                ...
                <tr>
                    <td>
                        <label class="mo_openid_checkbox_container"> <b>Static Pages</b>
