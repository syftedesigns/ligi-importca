    ...
    <form id="form-apps" name="form-apps" method="post" action="">
        ...
        <div style="min-height: 608px" class="mo_openid_table_layout">
            <div style="float: left;width: 55%;">
                ...
                <div style="width: 85%; float: left" class="note_style"><strong>*Custom background:</strong> This will change the background color of login icons.</div>
                ...
                <div style="width: 100%; float: left">
                    ...
                    <div style="width: 100%;">
                        <div style="width: 100%; float: left">
                            <label class="mo_openid_fix_fontsize">Enter text to show before the logout link. Use ##username## to display current username:</label>
