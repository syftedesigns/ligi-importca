        ...
        <form id="account_linking" name="premium_feature" method="post" action="" xmlns="http://www.w3.org/1999/html">
            ...
            <table>
                <tr>
                    <td colspan="2">
                        <div>
                            <label class="note_style"> Enable account linking to let your users link their Social accounts with existing WordPress account. Users will be prompted with the option to either link to any existing account using WordPress login page or register as a new user.</label><br/>
