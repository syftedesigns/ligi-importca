...
?>
    ...
    <div class="mo_openid_table_layout">
       ...
       <div>
         ...
         <br>  <label style="cursor: context-menu" class="mo-openid-radio-container_disable">Domain Restriction
               <input type="radio"   />
               <span class="mo-openid-radio-checkmark_disable"></span>
           </label>

        </div>
        <br/><label style="cursor: auto">Users with these domains will not be able to register.</label>
        <textarea rows="4" cols="50" class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 100%" disabled placeholder="Add domain names semicolon(;) separated e.g. gmail.com;yahoo.com;miniorange.com"/></textarea>
            ...
            <tr>
                <br>
                    <div>
                        <label style="cursor: context-menu" class="mo-openid-radio-container_disable">Allow Domain
                            <input type="radio" />
                            <span class="mo-openid-radio-checkmark_disable"></span>
                        </label>
                    </div>
                    <br/><label style="cursor: auto">Only users with these domains will be able to register.</label>
                    <textarea rows="4" cols="50" class="mo_openid_textfield_css" style="border: 1px solid ;border-color: #0867b2;width: 100%" disabled placeholder="Add domain names semicolon(;) separated e.g. gmail.com;yahoo.com;miniorange.com"/></textarea>
                </td>
              </tr>
        <td><br /><b><input disabled type="submit" name="submit" value="Save" style="width:150px;background-color:#0867b2;color:white;box-shadow:none;text-shadow: none;"  class="button button-primary button-large" />
            </b>
        </td>
    </tr>
    </table>
    ...
    <script>
        //to set heading name
        jQuery('#mo_openid_page_heading').text('Domain Restriction');
