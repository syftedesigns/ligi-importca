...
<div style="margin-left: 8%">
                    ...
                    <div id="below">
                        <p class="note_style" ><strong>NOTE:</strong>  The icons in above pages will be placed horizontally. For vertical icons, add <b>miniOrange Sharing - Vertical</b> widget from Appearance->Widgets.</p>
