    ...
    <div>
        <table>
            <tr>
                ...
                <td>
                    <button id="mo_openid_restart_gtour" style="margin-top: 23px;background: #0867B2;border-color: #0867B2;color: white; float: right" class="button" onclick="restart_tour()" value="Restart Tour">Restart Tour</button>
                </td>
            </tr>
        </table>
    </div>
        ...
        <div id="mo_openid_settings" style="width: 85%; float: right;">
            <div style="background-color: #FFFFFF;width: 90%;border-radius: 0px 15px 15px 0px;">
                <div class="mo_container">
                    <h3 id="mo_openid_page_heading" class="highlight" style="color: white;margin: 0;padding: 23px;border-radius: 0px 15px 0px 0px;">&nbsp</h3>
        ...
        var new_tour1 = new Tour({
            ...
            template: function () {
                ...
                if(new_tour1.getCurrentStep()===7)
                    return_value="<div style='margin-top:2%;font-size: unset !important' class=\"mo2f_popover\" role=\"tooltip\"> <div class=\"mo2f_arrow\" ></div> <h3 class=\"mo2f_popover-header\" style='margin-top: 0px'></h3> <div class=\"mo2f_popover-body\"></div> <div class=\"mo2f_popover-navigation\"> <div class=\"mo2f_tour_btn-group\"><div style=\"width:47%;margin-top: -7%;\"><h4  style=\"float:left;margin-top:30%;margin-left:30%;\">"+ (new_tour1.getCurrentStep()+1)+"/8</h4></div></div>&nbsp;&nbsp; <button class=\"button button-primary button-large\" data-role=\"end\" onclick=\"end_new_tour1();\">Done</button> </div> </div>";
                else {
                        return_value = "" +
                            "<div style='font-size: unset !important' class=\"mo2f_popover\" role=\"tooltip\"> " +
                                "<div class=\"mo2f_arrow\" ></div> " +
                                "<h3 class=\"mo2f_popover-header\" style=\"margin-top:0px;\"></h3> " +
                                "<div class=\"mo2f_popover-body\"></div> " +
                                "<div class=\"mo2f_popover-navigation\"> " +
                                    "<div class=\"mo2f_tour_btn-group\" style=\"width: 100%;\"> " +
                                        "<button class=\"mo2f_tour_btn mo2f_tour_btn-sm mo2f_tour_btn-secondary mo2f_tour_btn_next-success\" style=\"width: 54%;height: 0%;\" data-role=\"next\">Next &raquo;</button>&nbsp;&nbsp;" +
                                        "<button class=\"mo2f_tour_btn mo2f_tour_btn-sm mo2f_tour_btn-secondary mo2f_tour_btn_next-success\" style=\"width: 54%;height: 0%;\" data-role=\"end\" onclick=\"end_new_tour1();\">Skip</button>" +
